...
( 
    ...
    input wire           i_start, 
    input wire           i_cancel, 
    input wire [2:0]     i_product_code, 
    input wire           i_online_payment,  
    input wire [6:0]     i_total_coin_value, 
 
    //Outputs 
    output wire [3:0]     o_state, 
    output wire           o_dispense_product, 
    output wire [6:0]     o_return_change, 
    output wire [6:0]     o_product_price 
    ); 
...
localparam IDLE_STATE                   =4'b0000, 
            ...
            WATER_BOTTLE_SELECTON_STATE =4'b0110, 
            DISPENSE_AND_REUTRN_STATE   =4'b0111;  
    ...
    case(r_state) 
        ...
        SELECT_PRODUCT_STATE: begin 
            case(i_product_code) 
                ...
                3'b100:begin 
                    r_next_state = WATER_BOTTLE_SELECTON_STATE; 
        ...
        WATER_BOTTLE_SELECTON_STATE: begin  
            ...
            if(i_cancel) begin 
                ...
                r_next_state = DISPENSE_AND_REUTRN_STATE; 
        ...
        DISPENSE_AND_REUTRN_STATE: begin  
...
assign o_dispense_product = (r_state == DISPENSE_AND_REUTRN_STATE) ? 
1'b1: 1'b0; 
assign o_return_change =  (r_state == DISPENSE_AND_REUTRN_STATE) ? 
r_next_return_change: 1'b0;  
assign o_product_price =  (r_state == DISPENSE_AND_REUTRN_STATE) ? 
r_next_product_price: 1'b0; 
